...
const quizzes: Quiz[] = [
  ...
  { title: "Mental Fitness Score", titleFr: "Score de Fitness Mental", icon: Brain, descEn: "How strong is your mental muscle right now? This is your baseline - the starting point for everything we'll work on.", descFr: "Où en est ton fitness mental aujourd'hui ? C'est ton point de départ, la base de tout ce sur quoi on va travailler.", linkEn: "https://n3x9yc2lsn3.typeform.com/to/nozddA5i", linkFr: "https://n3x9yc2lsn3.typeform.com/to/uGtHIRDD" },
