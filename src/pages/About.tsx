...
const About = () => {
  ...
  const blocks = [
    {
      en: "It was early in my career that I understood what it really means to stay standing when everything is shifting. I was working in commercial aviation finance in 2001 when the Twin Towers collapsed. Overnight, all war risk policies were cancelled. Airlines went down. The bank I worked for found itself the active owner of around a hundred aircraft scattered across the world. There was no market left to sell them. So we created one: we built an operating lease business, which was not at all what a bank was designed to do. That's what real crisis management looks like.",
      fr: "C'est tôt dans ma carrière que j'ai compris ce que ça veut vraiment dire de tenir debout quand tout bouge. Je travaillais dans le financement de l'aviation commerciale en 2001 quand les Twin Towers se sont effondrées. Du jour au lendemain, toutes les polices de risque de guerre ont été annulées. Des compagnies aériennes ont coulé. La banque pour laquelle je travaillais s'est retrouvée propriétaire active d'une centaine d'avions dispersés dans le monde entier. Plus de marché pour les vendre. Alors on a créé un marché : on a monté une activité de location opérationnelle, ce qui n'était pas du tout le métier d'origine d'une banque. C'est ça, la vraie gestion de crise.",
    },
    {
